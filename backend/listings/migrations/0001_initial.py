    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing_type', models.CharField(choices=[('Terraced', 'Terraced'), ('Semi Detatched', 'Semi Detatched'), ('Detatched', 'Detatched'), ('Flat', 'Flat'), ('Undefined', 'Undefined')], default='Undefined', max_length=50)),
